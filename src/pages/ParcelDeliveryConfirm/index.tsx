...
const primaryButtonClass =
  "flex w-full items-center justify-center gap-2 rounded-xl bg-vr-800 px-5 py-3.5 text-[17px] font-bold text-white shadow-sm shadow-vr-900/15 transition hover:bg-vr-900 disabled:cursor-not-allowed disabled:bg-gray-400 disabled:shadow-none";
