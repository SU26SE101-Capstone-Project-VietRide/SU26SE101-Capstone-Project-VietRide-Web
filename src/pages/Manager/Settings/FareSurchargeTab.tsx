...
/**
 * Tab phụ thu giá vé theo dịp — `/v1/operator/fare-surcharges`.
 *
 * Các mục "chính sách đặt vé" và "chính sách gửi hàng" từng hiển thị ở đây chạy
 * bằng mock: BE không có endpoint, bấm lưu không đi đâu cả, và riêng phần hàng
 * hoá còn mô tả sai cách tính giá (BE tính theo tuyến:
 * max(minimumPriceVnd, chargeableWeightKg × pricePerKgVnd), cấu hình ở màn Hàng
 * hoá). Đã gỡ để UI không hứa thứ hệ thống không làm.
 */
...
export default function FareSurchargeTab() {
