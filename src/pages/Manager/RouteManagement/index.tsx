...
import { FiActivity, FiArrowDown, FiArrowUp, FiMap, FiRefreshCw, FiSearch } from "react-icons/fi";
...
export default function ManagerRouteManagementPage() {
  ...
  function sortIcon(column: typeof sortBy) {
    if (sortBy !== column) return <span aria-hidden="true" className="text-base leading-none text-gray-300">↕</span>;
