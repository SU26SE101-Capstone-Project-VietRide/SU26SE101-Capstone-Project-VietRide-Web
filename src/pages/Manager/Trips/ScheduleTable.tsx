...
import { FiCalendar, FiEdit2, FiPause, FiPlay, FiRepeat, FiSearch, FiSliders, FiTrash2, FiTruck, FiUsers, FiX } from "react-icons/fi";
    ...
    <div className="border-t border-gray-100 p-4">
      <div className="grid gap-3 lg:grid-cols-[minmax(360px,1.4fr)_220px_minmax(180px,0.8fr)_auto] lg:items-end">
        <div className="relative min-w-0">
          ...
          <input value={search} onChange={(event) => onSearchChange(event.target.value)} placeholder={t("trips.searchPlaceholder")} aria-label={t("trips.searchPlaceholder")} className="w-full rounded-lg border border-gray-200 bg-gray-50 py-2.5 pl-10 pr-4 text-sm outline-none focus:border-vr-500 focus:bg-white" />
        </div>
      ...
      {showAdvancedFilters ? <div className="mt-3 grid gap-3 rounded-xl border border-gray-200 bg-gray-50 p-3 md:grid-cols-2 xl:grid-cols-5">
        ...
        <div className="min-w-0">
          ...
          <CustomSelect value={vehicleTypeFilter} onChange={(event) => onVehicleTypeFilterChange(event.target.value)} aria-label={t("trips.filterVehicleType")} className="w-full rounded-lg border border-gray-200 bg-white px-3 py-2.5 text-sm">
            ...
            {vehicleTypes.map((vehicle) => <option key={vehicle.vehicleTypeId} value={vehicle.vehicleTypeId}>{vehicleTypeLabel(vehicle.vehicleType)}</option>)}
          </CustomSelect>
        </div>
      </div> : null}
