    ...
    <section className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
      ...
      <PersonnelTable
        ...
        columns={[
          ...
          { key: "size", header: t("parcels.sizeCategory"), headerClassName: "w-[14%] px-5 py-3", cellClassName: "w-[14%] px-5 py-4 text-sm text-gray-700", render: (item) => <>{item.sizeCategory ? t(`parcels.sizeCategories.${item.sizeCategory}`, { defaultValue: item.sizeCategory }) : "-"}<br /><span className="text-xs text-gray-500">{item.actualWeightKg == null ? "-" : `${item.actualWeightKg} kg`}</span></> },
