            ...
            <div className="space-y-6">
              ...
              {serverOperator && (
                <div className="border-t border-gray-200 pt-6">
                  ...
                  {/* Chính sách hoàn vé đã chuyển sang màn Cấu hình — để lại
                      lối đi cho người đã quen sửa nó ở đây. */}
                  <p className="mt-4 text-sm text-gray-600">
                    {t("profilePage.cancellationMovedHint")}{" "}
                    <Link
                      to="/manager/settings"
                      className="font-semibold text-vr-800 hover:underline"
                    >
                      {t("profilePage.cancellationMovedLink")}
                    </Link>
                  </p>
                </div>
              )}
