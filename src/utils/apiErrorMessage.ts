...
const vietnameseMessages: Record<string, string> = {
  ...
  IDEMPOTENCY_KEY_MISMATCH:
    "Yêu cầu bị trùng khóa nhưng dữ liệu không giống nhau.",
  ...
  RATE_LIMIT_EXCEEDED:
    "Bạn đã vượt quá giới hạn số lần thao tác, vui lòng thử lại sau.",
  ...
  USER_NOT_PASSENGER:
    "Chỉ tài khoản hành khách mới thực hiện được thao tác này.",
  ...
  BOOKING_EDIT_PICKUP_PRICE_CHANGED:
    "Giá vé đã thay đổi sau khi đổi điểm đón, vui lòng thử lại.",
  BOOKING_MAX_SEATS_EXCEEDED:
    "Một lượt đặt không được vượt quá số ghế tối đa cho phép.",
  ...
  BOOKING_PENDING_ACTION_SUPERSEDED:
    "Yêu cầu đã bị thay thế bởi một yêu cầu khác.",
  ...
  BOOKING_TRANSFER_SEAT_PENDING:
    "Ghế đang chờ xác nhận chuyển, vui lòng thử lại sau.",
  ...
  INVOICE_NUMBER_EXHAUSTED:
    "Đã hết số hóa đơn khả dụng, vui lòng liên hệ hỗ trợ.",
  ...
  REFUND_FAILURE_PERSISTED:
    "Hoàn tiền thất bại, hệ thống đã ghi nhận để xử lý lại.",
  ...
  OPERATOR_LOOKUP_UNAVAILABLE:
    "Không tra cứu được thông tin nhà xe, vui lòng thử lại.",
  ...
  PARCEL_CARGO_RECOVERY_IN_PROGRESS:
    "Kiện hàng đang trong quá trình xử lý khôi phục.",
  ...
  PARCEL_PRICING_NOT_CONFIGURED:
    "Chưa cấu hình bảng giá hàng hóa cho tuyến này.",
  ...
  INVALID_DECISION:
    "Quyết định duyệt không hợp lệ, chỉ nhận APPROVED hoặc REJECTED.",
  INVALID_REFUND_AMOUNT:
    "Kiện hàng này không có khoản hoàn tiền nào để xác nhận.",
  ...
  PLATFORM_WALLET_INSUFFICIENT_BALANCE:
    "Số dư ví hệ thống không đủ để thực hiện giao dịch.",
  ...
  POLICY_VERSION_CONFLICT:
    "Chính sách vừa được cập nhật bởi người khác, vui lòng tải lại.",

  // RAG (trợ lý AI)
  RAG_ACCESS_DENIED_FOR_ROLE:
    "Vai trò của bạn không có quyền truy cập tính năng này.",
  ...
  RAG_DOCUMENT_FILE_UNSUPPORTED:
    "Hệ thống không hỗ trợ loại file tài liệu này.",
  RAG_DOCUMENT_NOT_APPROVED: "Tài liệu chưa được duyệt.",
  RAG_DOCUMENT_NOT_FOUND: "Không tìm thấy tài liệu.",
  RAG_DOCUMENT_STATUS_CONFLICT:
    "Trạng thái tài liệu không cho phép thao tác này.",
  ...
  RAG_OPERATOR_SCOPE_FORBIDDEN:
    "Bạn không có quyền truy cập dữ liệu nhà xe này.",
  ...
  RAG_STORAGE_INVALID_RESPONSE:
    "Kho lưu trữ tài liệu trả về dữ liệu không hợp lệ.",
  ...
  ROUTE_CHANGE_PROPOSAL_NOT_PENDING:
    "Đề xuất đổi tuyến không còn ở trạng thái chờ duyệt.",
  ...
  STOP_DISABLED_BOOKING_AFFECTED:
    "Vô hiệu hoá điểm dừng sẽ ảnh hưởng tới các vé đã đặt.",
  ...
  STOP_REPLACEMENT_DIFFERENT_OPERATOR:
    "Không thể thay thế điểm dừng của nhà xe khác.",
  ...
  SHUTTLE_DISTANCE_EXCEEDED:
    "Khoảng cách vượt quá phạm vi trung chuyển cho phép.",
  ...
  SHUTTLE_PASSENGERS_INCOMPLETE:
    "Danh sách hành khách trung chuyển chưa đầy đủ.",
  SHUTTLE_PASSENGER_INVALID_STATE:
    "Trạng thái hành khách trung chuyển không hợp lệ.",
  ...
  SHUTTLE_REQUEST_SET_CHANGED:
    "Danh sách yêu cầu trung chuyển đã thay đổi, vui lòng tải lại.",
  ...
  SUBSCRIPTION_MODULE_DISABLED:
    "Tính năng này không nằm trong gói cước hiện tại.",
  SUBSCRIPTION_PAYMENT_NOT_RETRYABLE:
    "Không thể thanh toán lại cho gói cước này.",
  ...
  STARTER_PLAN_REQUIRED:
    "Không thể tắt gói Starter — đây là gói mặc định bắt buộc.",
  ...
  TRACKING_DEPENDENCY_UNAVAILABLE:
    "Dịch vụ theo dõi hành trình hiện không khả dụng.",
  TRACKING_ROUTE_CONTEXT_UNAVAILABLE:
    "Không lấy được dữ liệu tuyến để theo dõi.",
  ...
  TRACKING_SHARE_TOKEN_INVALID:
    "Link chia sẻ hành trình không hợp lệ hoặc đã hết hạn.",
  ...
  TRIP_BOARDING_TOO_EARLY: "Chưa tới giờ được mở đón khách cho chuyến này.",
  TRIP_CARGO_CAPACITY_EXCEEDED: "Hàng hóa vượt quá sức chứa của chuyến.",
  TRIP_CARGO_TRANSFER_CONFLICT:
    "Việc chuyển hàng hóa giữa các chuyến bị xung đột.",
  ...
  TRIP_INVALID_TRANSITION:
    "Trạng thái chuyến hiện không cho phép thao tác này.",
...
const vietnameseFieldMessages: Record<string, string> = {
  ...
  "minOrderAmount cannot be negative.": "Giá trị đơn tối thiểu không được âm.",
  ...
  "tripId is required and must be a non-empty UUID.": "Thiếu mã chuyến hợp lệ.",
  "Caller operator id must not be empty.":
    "Thiếu thông tin nhà xe của người thực hiện.",
  "code must not exceed 50 characters.": "Mã không được vượt quá 50 ký tự.",
...
const fluentValidationRules: Array<{
  ...
  },
  {
    ...
    translate: (m) =>
      capitalize(`${fieldLabel(m[1])} không đúng định dạng email.`),
  },
  {
  ...
  },
  {
    ...
    translate: (m) =>
      capitalize(
        `${fieldLabel(m[1])} phải nằm trong khoảng ${m[2]} đến ${m[3]}.`,
      ),
  },
  {
  ...
  },
  {
    ...
    translate: (m) =>
      capitalize(`${fieldLabel(m[1])} không được bằng ${m[2]}.`),
  },
  {
...
export function translateApiErrorMessage(
  ...
  if (status !== undefined && status >= 500)
    return vietnameseMessages.INTERNAL_ERROR;
  return fallback;
}
